...
app.get('/:listingID/0.reviewBundle.js', (req, res) => {
  axios.get(`http://54.215.44.35/${req.params.listingID}/0.reviewBundle.js`)
    .then((bundleResponse) => {
...
app.get('/:listingID/1.reviewBundle.js', (req, res) => {
  axios.get(`http://54.215.44.35/${req.params.listingID}/1.reviewBundle.js`)
    .then((bundleResponse) => {
      res.send(bundleResponse.data);
    })
    .catch((err) => {
...
app.get('/:listingID/2.reviewBundle.js', (req, res) => {
  axios.get(`http://54.215.44.35/${req.params.listingID}/2.reviewBundle.js`)
    .then((bundleResponse) => {
      res.send(bundleResponse.data);
    })
    .catch((err) => {
...
app.get('/:listingID/3.reviewBundle.js', (req, res) => {
  axios.get(`http://54.215.44.35/${req.params.listingID}/3.reviewBundle.js`)
    .then((bundleResponse) => {
      res.send(bundleResponse.data);
    })
    .catch((err) => {
...
app.get('/checkoutInformation/:propertyId', (req, res) => {
  // my url
    ...
    var tempUrl = `http://13.56.184.144:3000/checkoutInformation/${id}/`
